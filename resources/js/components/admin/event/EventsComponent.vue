<template>
    <div class="events-index-container">
        ...
        <div class="events-list">
            ...
            >
                <img
                    class="events-list__event-image"
                    :src="'/images_dynamic/events/' + event.image"
                />

                <div class="events-list__event-info">
                    <span class="events-lists__event-title">{{
                        event.name
                    }}</span>
                    <div class="events-list__event-date-entry">
                        <div class="events-list__event-date">
                            {{ formatDate(event.date) }} - {{ formatTime(event.time )}}
                        </div>
                        
                        <div v-if="event.price == 0" class="events-list__event-entry">prosti vstop</div>
                        <div v-if="event.price != 0" class="events-list__event-entry">{{ event.price }} €</div>
                    </div>
                </div>
            </a>
        </div>
