...
@push('title')
Uredi tedensko ponudbo
@endpush

<div id="app">
    <edit-weekly-component :food="{{ $food }}" :categories="{{ json_encode($categories) }}" :allergens="{{ json_encode($allergens) }}" :db_selected_allergens="{{ json_encode($db_selected_allergens) }}"></edit-weekly-component>
</div>
