            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3 class="p-bold">{{__('Are you sure you want to delete unfinished stocktaking?')}}</h3>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="drinks-food-create-edit__bottom-buttons two-button-wrapper">
                            ...
                            <!-- YES -->
                            <a class="w-100" href="{{route('mystocktaking.delete',$stocktaking->id)}}">
        ...
        <div class="modal fade warning-popup" id="save-stocktaking">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <h3 class="p-bold">{{__('Are you sure you want to save unfinished stocktaking?')}}</h3>
                    </div>
                    ...
                    <div class="modal-footer">
                        <div class="drinks-food-create-edit__bottom-buttons two-button-wrapper">
                            ...
                            <!-- YES -->
                            <a class="w-100" href="{{route('mystocktaking.save',$stocktaking->id)}}">
                                <button class="drinks-food-create-edit__add-allergens-button" style="border: 2px solid #1C6979;">
                                    {{__('Yes')}}
                                </button>
                            </a>
        ...
        <div class="drinks-food-create__container">
            <div class="drinks-food-create__container">
                ...
                <div class="drinks-food-create-edit__form-container">
                    ...
                    <p class="p-info">{{ __('Unfinished stocktaking text') }}</p>

                    <!-- DATE -->
                    <p class="p-info">
                        <span class="p-bold">{{__('Date')}}: </span>
                        <span>{{timestampToDate($stocktaking->start)}}</span>
                    </p>

                    <!-- DATE -->
                    <p class="p-info">
                        <span class="p-bold">{{__('Time')}}: </span>
                        <span>{{timestampToTime($stocktaking->start)}}</span>
                    </p>
                ...
                <div class="drinks-food-create-edit__bottom-buttons mt-3">
                    <a class="w-100" href="{{route('mystocktaking.app',$stocktaking->id)}}">
                    <button>{{__('Continue stocktaking')}}</button>
                    </a>
                </div>
            </div>
        </div>
