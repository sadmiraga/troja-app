                                    ...
                                    <tr>
                                        <td align="center" class="container-padding">
                                            ...
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                align="center" style="width:100%; max-width:100%;">
                                                <tr>
                                                    <td style="font-size:20px;height:20px;line-height:20px;">&nbsp;
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td align="center" valign="middle"
                                                        style="font-family:'Poppins', sans-serif;color:#191919;font-size:22px;line-height:32px;font-weight:700;letter-spacing:0px;padding:0;padding-bottom:10px;">
                                                        FNX rezervacija
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle"
                                                        style="text-align:left !important;font-family:'Poppins', sans-serif;color:#939393;font-size:14px;line-height:24px;font-weight:400;letter-spacing:0px;padding:0;padding-bottom:30px;">


                                                        {{$submission->first_name}} {{$submission->last_name}} je zainteresiran za najem FNX restavracije
                                                        <br><br>
                                                        Odgovori: <br><br>
                                                        <span>Elektronski naslov: {{$submission->email}}</span><br>
                                                        <span>Telefonska številka: {{$submission->phone}}</span><br>
                                                        <span>Podjetje: {{$submission->company}}</span><br>
                                                        <span>Število oseb: {{$submission->number_of_guests}}</span><br>
                                                        <span>Datum: {{$submission->date}}</span><br>
                                                        <span>Opombe: {{$submission->notes}}</span><br>
                                                ...
                                                <tr>
                                                    <td align="center" valign="middle">
                                                        <table border="0" align="center" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    style="background-color:#A46AC0;display:block;mso-padding-alt:14px 40px 14px 40px;border-radius:45px;">
                                    ...
                                    <tr>
                                        <td align="center" class="container-padding">
                                            ...
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td
                                                        style="background-color:#F1F1F1;font-size:3px;height:3px;line-height:3px;">
                                                        &nbsp;</td>
                                                </tr>
                                    ...
                                    <tr>
                                        <td align="center" class="container-padding">
                                            ...
                                            <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                <tr>
                                                    <td style="font-size:40px;height:80px;line-height:40px;">&nbsp;
                                                    </td>
                                                </tr>
